...
<body>
    <h1 align="center">DATA PEMESANAN MOBILE LAGENDS</h1>
    <table border="1" align="center">
        ...
        $no = 1;
        $query = mysqli_query($registrasi, 'SELECT * FROM pesanan_mlbb ORDER BY id_member DESC LIMIT 1');
        ...
        <tr align="center">
            ...
            <td>
                <?php echo $data['user_id']."(".$data['zone_id'].")" ?>
            </td>
            <td>
